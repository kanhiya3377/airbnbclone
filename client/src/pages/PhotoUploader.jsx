      ...
      <div className="mt-2 grid gap-2 grid-cols-3 lg:grid-cols-6 md:grid-cols-4">
        {addedPhotos.length > 0 &&
          addedPhotos.map((link, index) => (
            <div key={link || index} className="h-32 flex w-full relative">
              <img
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-2 right-2 text-white bg-black py-2 px-3 bg-opacity-50 rounded-xl "
              >
                <svg
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-2 left-1 text-white bg-black py-2 px-3 bg-opacity-50 rounded-xl "
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
